...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "w2M3QYLb#_uK5DUuKJX2dyp--puAOA0Bod9ONydYpk2InP0F6cPA",
  // ADD Your Session Id 
  MONGODB: process.env.MONGODB || "mongodb+srv://hasamg:xlwPPyGX6GedR9xD@cluster0.9qiarq4.mongodb.net/",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94754625969",
  //========================================- OTHER - CONFIGS -=====================================================================
  ...
  packname: process.env.packname || "🖤✨️ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𓄂ʙʟᴀᴄᴋ ᴀʟꜰᴀ࿐ ᴏꜰᴄ ²⁰²⁴᭄✨️🖤",
  author: process.env.author || "⚡ᴍʀ ᴀʟꜰᴀ🔰",
  //==========================================- API-CONFIGS -==========================================================
